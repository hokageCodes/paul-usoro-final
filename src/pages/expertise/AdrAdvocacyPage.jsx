...
const { title, description, practicalExperience } = expertiseData.adrAndAdvocacy;

const AdrAdvocacyPage = () => {
  ...
  return (
    ...
    <OtherPracticeAreas currentTitle="Adr & Advocacy" />
    </>
  );
};

export default AdrAdvocacyPage;
