...
const { title, description, practicalExperience } = expertiseData.communicationLaw;

const CommunicationLawPage = () => {
  ...
  return (
    ...
    <OtherPracticeAreas currentTitle="Communications Law" />
    </>
  );
};

export default CommunicationLawPage;
