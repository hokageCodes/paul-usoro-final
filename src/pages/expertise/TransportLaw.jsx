...
const { title, description } = expertiseData.transportationLaw;

const TransportLawPage = () => {
...
//   };
  ...
  return (
    <>
      ...
      <OtherPracticeAreas currentTitle="Transportation Law" />
    </>
  );
};

export default TransportLawPage;
